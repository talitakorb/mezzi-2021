...
ScrollReveal().reveal('.reveal:nth-of-type(1)', {
  delay: 500,
})

ScrollReveal().reveal('.reveal:nth-of-type(2)', {
  delay: 800,
})

ScrollReveal().reveal('.reveal:nth-of-type(3)', {
  delay: 1100,
})

ScrollReveal().reveal('.reveal:nth-of-type(4)', {
delay: 1200,
})

ScrollReveal().reveal('.reveal:nth-of-type(5)', {
delay: 1500,
})

ScrollReveal().reveal('.reveal:nth-of-type(6)', {
delay: 1800,
})

ScrollReveal().reveal('.reveal:nth-of-type(7)', {
delay: 2100,
})

ScrollReveal().reveal('.reveal:nth-of-type(8)', {
delay: 2400,
})

ScrollReveal().reveal('.reveal:nth-of-type(9)', {
delay: 2700,
})

ScrollReveal().reveal('.reveal:nth-of-type(10)', {
delay: 3000,
})

ScrollReveal().reveal('.reveal:nth-of-type(11)', {
delay: 3000,
})

ScrollReveal().reveal('.reveal:nth-of-type(12)', {
delay: 3000,
})
...
jQuery(function() {
    ...
    jQuery("#resize").toggleClass("active");
    });
});
...
var svgEltwo = document.querySelector('.animated-lines-two');
...
var createLinesTwo = function() {

    var newPathElTwo = document.createElementNS('http://www.w3.org/2000/svg', 'path'),
    ...
    var animLoop = function() {
        newPathElTwo.setAttribute('d', createPathString());
      requestAnimationFrame(animLoop);
    }
    svgEltwo.appendChild(newPathElTwo);
    animLoop();
...
var productdivs = jQuery(".faq-individual");
for(var i = 0; i < productdivs.length; i+=5) {
  productdivs.slice(i, i+5).wrapAll("<div class='wrap-pergunta-resposta'></div>");
}


/** FORM ORÇAMENTO **/
jQuery( ".half-input" ).wrapAll( "<div class='wrap-input' />");